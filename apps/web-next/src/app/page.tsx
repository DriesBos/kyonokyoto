...
import { CITY_COOKIE, cityConfigFor, citySupportsLocale, defaultLocaleForCity, normalizeCity } from '@/lib/cities';
...
export default async function Home() {
  ...
  const locale = requestedLocale && citySupportsLocale(config, requestedLocale)
    ? requestedLocale
